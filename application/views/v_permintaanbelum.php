...
<div class="content-wrapper">
    ...
    <div class="page-header page-header-default">
        <div class="breadcrumb-line">
            <ul class="breadcrumb">
                <li><a href="<?php echo base_url('dashboard') ?>"><i class="icon-home2 position-left"></i>Beranda</a>
                </li>
                <li class="active">Permintaan Operasi</li>
                <li class="active">Belum Dikonfirmasi</li>
            </ul>
        </div>
    </div>
    <!-- /float buttons with text -->
    ...
    <div class="content">
        ...
        <div class="panel panel-warning">
            <div class="panel-heading">
                <h6 class="panel-title">DATA PEMESANAN JADWAL OPERASI BELUM KONFIRMASI</h6>
            </div>
                                        ...
                                        <div class="modal-body">
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <label><b>Tgl. Pelayanan Operasi<span class="text-danger"> *</span></b></label>
                                                            <input id="tglpelaksanaanop" type="date" class="form-control" style="color:black" required="required">
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <label><b>Jam Pelayanan Operasi<span class="text-danger"> *</span></b></label>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $('#tampil_data').dataTable({
                    ...
                    "ajax": {
                        "url": "<?php echo base_url('permintaanbelum/permintaanList') ?>",
                        "type": "POST",
                    },
                    "deferRender": true,
                    "lengthMenu": [
                    ...
                    "columnDefs": [{
                        ...
                        },
                        {
                            "render": function(data, type, row) {
                                ...
                                let html = /*html*/ `<a data-toggle='modal' data-target='#modal_full' onclick="getDetail('${ noregistrasi}')">${noregistrasi}</a>`;
                                return html;
                            },
                            "targets": [1],
                            "orderable": false,
                        ...
                        {
                            "render": function(data, type, row) {
                                let dokterop = row.dokterop.substring(1);
                                return dokterop;
                            },
                            "targets": [4],
                            "width": "15%",
                        ...
                        {
                            "render": function(data, type, row) {
                                let html = row.instalasi.toUpperCase()
                                return html;
                            },
                            "targets": [5],
                            "width": "10%",
                        ...
                        },
                        {
                            "render": function(data, type, row) {
                                let noregistrasi = row.noregop
                                let html = /*html*/ `<a data-popup='tooltip' title='Konfirmasi Jadwal' data-toggle='modal' data-target='#modal_full' type='button' onclick="getDetail('${noregistrasi}')" class='btn btn-primary btn-icon'><i class='glyphicon glyphicon-pencil'></i></a>`;
                                return html;
                            },
                            "targets": [9],
                            "orderable": false,
            ...
            function getDetailPasien(norm) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('permintaanbelum/getDetailPasien'); ?>",
                    dataType: "JSON",
                    data: {
                        norm: norm
                    },
                    success: function(data) {
                        ...
                        let alamat = data.alamat + ", " + data.kelurahan + ", " + data.kecamatan + ", " + data
            ...
            function getDetailAsalPasien(noregistrasi) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('permintaanbelum/getDetailAsalPasien'); ?>",
                    dataType: "JSON",
                    data: {
            ...
            function getDetail(noregop) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('permintaanbelum/getDetailPemesananOperasi'); ?>",
                    dataType: "JSON",
                    data: {
                        noregop: noregop
                    },
            ...
            function getDetailTindakan(noregop) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('permintaanbelum/getDetailTindakanPasien'); ?>",
                    dataType: "JSON",
                    data: {
                        noregop: noregop
                    },
                    success: function(data) {
                        ...
                        _('dokterop').value = data[0].dokterop.substring(1);
                    }
                });
            }
            ...
            function getDiagnosaPrapost(noregop) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('permintaanbelum/getDiagnosaPrapost'); ?>",
                    data: {
                        noregop: noregop
                    },
                    dataType: "JSON",
            ...
            function getDiagnosaPasien(norm) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('permintaanbelum/getDiagnosaPasien'); ?>",
                    data: {
                        norm: norm
                    },
                    dataType: "JSON",
            ...
            function updateTanggalKonfirmasi() {
                ...
                let tglpelaksanaanop = _('tglpelaksanaanop').value;
                let jampelaksanaanop = _("jampelaksanaanop").value;
                if (tglpelaksanaanop == '' && jampelaksanaanop == '') {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url('permintaanbelum/updateKonfirmasiOP/konfirm'); ?>",
                        data: {
                            noregop: noregop,
                ...
                swal({
                    ...
                    function(isConfirm) {
                        if (isConfirm) {
                            $.ajax({
                                type: "POST",
                                url: "<?php echo base_url('permintaanbelum/updateKonfirmasiOP/batal'); ?>",
                                data: {
                                    noregop: noregop
                                },
                                success: function() {
