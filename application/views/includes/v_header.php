    ...
    <div class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="navbar-collapse collapse" id="navbar-mobile">
            ...
            <div class="navbar-right">
                <ul class="nav navbar-nav">
                    <!-- <li><a href="#"><i class="icon-user-plus"></i> <span></span></a></li> -->
                    <!-- <audio id="myAudio" autoplay>
						  <source src="<?php echo base_url(); ?>template/assets/sound/notif.ogg" type="audio/ogg">
						  <source src="<?php echo base_url(); ?>template/assets/sound/notif.mp3" type="audio/mpeg">
    ...
    function logout() {
        ...
        function(isConfirm) {
            if (isConfirm) {
                ...
                localStorage.removeItem("jenisop");
