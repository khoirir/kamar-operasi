                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-3">
                                                <input id="norm" name="norm" type="text" class="form-control" style="color:black" onkeyup="caripasien(this,event)" required>
...
<script type="text/javascript">
            ...
            "columns": [
                {
                    ...
                    "render": function (data, type, row) {
                        ...
                        var html = "<button type='button' class='btn btn-primary btn-rounded btn-labeled btn-xs' onclick=\"getDetailPasien('"+norm+"')\" data-dismiss='modal'><b><i class='icon-checkmark4'></i></b>PILIH</button>";
                        return html;
                    }
                }
            ],
    ...
    function getDetailPasien(norm){
        if(norm!==""){
            $.ajax({
                type: "GET",
                url: _('get_noregop').value==""?"<?php echo base_url('laporanhasiloperasi/getDataLaporan');?>/"+norm:"<?php echo base_url('laporanhasiloperasi/getEditDataLaporan');?>/"+norm,
                dataType: "JSON",
                success: function (data) {
                    if(data['pasien']!=null){
                        if(data['pasien'].statustindakan==='1'){
                            if(data['pasien'].statuspembayaran!='LUNAS'){
                            ...
                            swal({
                                title: "Gagal",
                                text: "No. RM "+data['pasien'].norm+" Belum Dilakukan Tindakan Operasi!",
                                confirmButtonColor: "#EF5350",
                                type: "warning",
                        ...
                        swal({
                            title: "Gagal",
                            text: "No. RM "+getNorm0+norm+" Belum Registrasi Operasi!",
                            confirmButtonColor: "#EF5350",
                            type: "warning",
                            onClose:_('norm').focus()
                        });
