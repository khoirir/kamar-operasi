...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <form role="form" action="operasiselesai/eksporXls" method="POST" class="form-horizontal" onsubmit="return eksporExcel()">
                                ...
                                <div class="tab-content">
                                        ...
                                        <div class="modal-body">
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="dokteranestesi" rows="2" cols="5" class="form-control" disabled="disabled" style="color:black"></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label><b>Asisten Anestesi</b></label>
                                                    <textarea id="asistenanestesi" rows="2" cols="5" class="form-control" disabled="disabled" style="color:black"></textarea>
                                                </div>
                                            </fieldset>
                                            <br>
                                            <fieldset>
                                                <legend class="text-semibold"><img style="float: left; width: 20px; height: auto; margin-right: 6px;" src="<?php echo base_url(); ?>/template/assets/css/icons/anestesi2.png">TINDAKAN ANESTESI</legend>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="jenisanestesi" rows="2" cols="5" class="form-control" disabled="disabled" style="color:black"></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label><b>Tindakan Anestesi</b></label>
                                                    <textarea id="tindakananestesi" rows="2" cols="5" class="form-control  text-uppercase" disabled="disabled" style="color:black"></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label><b>Keterangan</b></label>
                                                    <input id="keterangananestesi" type="text" class="form-control  text-uppercase" disabled="disabled" style="color:black">
                                                </div>
                                            </fieldset>
                                        </div>
                                    </div>
                                    <div class="tab-pane" id="tab-tindakan-operasi">
                                        <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            ...
                                                            <textarea id="dokteroperator" rows="2" cols="5" class="form-control" disabled="disabled" style="color:black"></textarea>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <label><b>Perawat Instrument</b></label>
                                                            <textarea id="perawatinstrument" rows="2" cols="5" class="form-control" disabled="disabled" style="color:black"></textarea>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <label><b>Radiografer</b></label>
                                                            <textarea id="radiografer" rows="2" cols="5" class="form-control" disabled="disabled" style="color:black"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label><b>Asisten Operasi</b></label>
                                                            <textarea id="asistenop" rows="2" cols="5" class="form-control" disabled="disabled" style="color:black"></textarea>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <label><b>Perawat Sirkuler</b></label>
                                                            <textarea id="perawatsirkuler" rows="2" cols="5" class="form-control" disabled="disabled" style="color:black"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </fieldset>
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    <label><b>Kamar Operasi</b></label>
                                                    <input id="kamarop" type="text" class="form-control" style="color:black" disabled="disabled">
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <label><b>Jam Induksi</b></label>
                                                            <input id="jaminduksi" type="text" class="form-control" style="color:black" disabled="disabled">
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <label><b>Jam Incisi</b></label>
                                                            <input id="jamincisi" type="text" class="form-control" style="color:black" disabled="disabled">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                    ...
                                    <div class="tab-pane" id="tab-tindakan-rr">
                                        <div class="modal-body">
                                            <fieldset>
                                                <div class="form-group">
                                                    <label><b>Tgl. Tindakan RR</b></label>
                                                    <input id="tgltindakanrr" type="text" class="form-control" disabled='disabled'>
                                                </div>
                                                <br>
                                                <div class="form-group">
                                                    <div class="table-responsive">
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $('#tglawal').val(localStorage.getItem("tglawal"));
                $('#tglakhir').val(localStorage.getItem("tglakhir"));
                $("#selectjenisoperasi").val(localStorage.getItem("jenisop") == null ? "!='ehem'" : localStorage.getItem("jenisop")).trigger("change");
                $("#selectoperator").val(localStorage.getItem("operator") == null ? "!='ehem'" : localStorage.getItem("operator")).trigger("change");
                tampilDataTabel();
            });
                ...
                var tabel = $('#tampil_data').dataTable({
                    ...
                    "ajax": {
                        ...
                        complete: function(data) {
                            ...
                            localStorage.setItem("jenisop", jenisop);
                    ...
                    "columnDefs": [{
                        ...
                        },
                        {
                            ...
                            "orderable": false,
                            "render": function(data, type, row) {
                                let kamarop = row.kamarop == null ? "-" : row.kamarop;
                                return kamarop;
                            },
                            "className": "text-center",
                            "width": "5%"
                        },
                        {
                            "render": function(data, type, row) {
                                ...
                                let html = "<button data-popup='tooltip' title='" + tittle + "' type='button' onclick=\"inputMutu('" + noregistrasi + "');\" class='btn " + btn_class + " btn-icon'><i class='glyphicon glyphicon-pencil'></i></button>";
            ...
            function getTindakanAnestesi(noregop) {
                $.ajax({
                    ...
                    dataType: "JSON",
                    success: function(data) {
                        if (data.dokteranestesi != null) {
                            let list = data.dokteranestesi.split(';').join("\n-  ");
                            _("dokteranestesi").value = list.substring(1);
                        }
                        if (data.asistenanestesi != null) {
                            let list = data.asistenanestesi.split(';').join("\n-  ");
                            _("asistenanestesi").value = list.substring(1);
                        }
                        _("wakttindakananestesi").value = data.tgltindakananestesi;
                        if (data.jenisanestesi != null) {
                            let list = data.jenisanestesi.split(';').join("\n-  ");
                            _("jenisanestesi").value = list.substring(1);
                        }
                        if (data.tindakananestesi != null) {
                            let list = data.tindakananestesi.split(';').join("\n-  ");
                            _("tindakananestesi").value = list.substring(1);
                        }
                        _("keterangananestesi").value = data.keterangan;
                    },
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.dokterop != null) {
                            let list = data.dokterop.split(';').join("\n-  ");
                            _("dokteroperator").value = list.substring(1);
                        }
                        if (data.asistenop != null) {
                            let list = data.asistenop.split(';').join("\n-  ");
                            _("asistenop").value = list.substring(1);
                        }
                        if (data.perawatinstrument != null) {
                            let list = data.perawatinstrument.split(';').join("\n-  ");
                            _("perawatinstrument").value = list.substring(1);
                        }
                        if (data.perawatsirkuler != null) {
                            let list = data.perawatsirkuler.split(';').join("\n-  ");
                            _("perawatsirkuler").value = list.substring(1);
                        }
                        if (data.radiografer != null) {
                            let list = data.radiografer.split(';').join("\n-  ");
                            _("radiografer").value = list.substring(1);
                        }
                        _("kamarop").value = data.kamarop;
                        _("wakttindakanop").value = data.tgltindakanop;
                        _("jaminduksi").value = data.jaminduksi != null ? ubahFormatTanggal(data.jaminduksi, 0) : "";
                        _("jamincisi").value = data.jamincisi != null ? ubahFormatTanggal(data.jamincisi, 0) : "";
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        for (let i = 0; i < data.length; i++) {
                            ...
                            JMLTINDAKAN.style.textAlign = "center";
                            ...
                            OPERATOR.innerHTML = data[i].operator;
            ...
            function getDetailTindakanRR(notindakanop) {
                $.ajax({
                    type: 'POST',
                    url: "<?php echo base_url('operasiselesai/getTindakanRRPasien') ?>",
                    data: {
                    ...
                    success: data => {
                        ...
                        let html = '';
                        data.forEach(d => {
                            let petugas = d.petugas.split(";").join("<br/>" + "- ").substring(5);
                            html += /*html*/
                                `<tr>
                                    <td>${petugas}</td>
                                    <td>${d.tindakan}</td>
                            ...
                            _("tgltindakanrr").value = d.tgltindakan;
                        });
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        for (let i = 0; i < data.length; i++) {
                            ...
                            let HASIL = row_insert.insertCell(0);
                            HASIL.style.textAlign = "center";
                            let AKSI = row_insert.insertCell(1);
                            AKSI.style.textAlign = "center";
                            let IDUSER = row_insert.insertCell(2);
                            IDUSER.style.display = "none";
                            let TGLUSER = row_insert.insertCell(3);
                            TGLUSER.style.display = "none";
            ...
            function clearFormDetail() {
                ...
                _("dokteranestesi").value = "";
                _("asistenanestesi").value = "";
                _("wakttindakananestesi").value = "";
                _("jenisanestesi").value = "";
                _("tindakananestesi").value = "";
                _("keterangananestesi").value = "";
                _("dokteroperator").value = "";
                _("asistenop").value = "";
                _("perawatinstrument").value = "";
                _("perawatsirkuler").value = "";
                _("radiografer").value = "";
                _("kamarop").value = "";
