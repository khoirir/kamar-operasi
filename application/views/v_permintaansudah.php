                                        ...
                                        <div class="modal-body">
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="dokterop" rows="2" cols="5" class="form-control" disabled="disabled" style="color:black"></textarea>
                                                </div>
                                                <div class="form-group">
                    ...
                    "columnDefs": [{
                        ...
                        },
                        {
                            "render": function(data, type, row) {
                                let noregistrasi = row.noregop;
                                let norm = row.norm;
                                let waktupelaksanaan = row.tgljadwalop;
                                let html = /*html*/ `<a data-popup='tooltip' title='Isi Tindakan' type='button' onclick="inputTindakan('${noregistrasi}','${waktupelaksanaan}')" class='btn btn-primary btn-icon'><i class='glyphicon glyphicon-pencil'></i></a>`;
                                return html;
                            },
                            "targets": [10],
                            "orderable": false,
            ...
            function getDetailTindakan(noregop) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data[0].dokterop != null) {
                            let list_dokter = data[0].dokterop.split(';').join("\n-  ");
