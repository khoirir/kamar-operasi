...
class M_permintaansudah extends CI_Model{
    ...
    public function filter($search, $limit, $start, $order_field, $order_ascdesc){
        $where="statusop='1' AND (norm LIKE '%$search%' OR pasien LIKE '%$search%' OR dokterop LIKE '%$search%' OR instalasi LIKE '%$search%' OR unit LIKE '%$search%' OR tglpermintaanop2 LIKE '%$search%' OR tglkonfirmasiop2 LIKE '%$search%' OR jenisop LIKE '%$search%' OR noregop LIKE '%$search%')";
        $this->db->where($where);
