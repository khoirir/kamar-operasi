...
class M_mutupelayanan extends CI_Model{
    ...
    function updateMutuPelayanan($id,$data){
        ...
        return $this->db->update('t_mutukamarop', $data);
    }

    function insertMutuPelayanan($data){
        return $this->db->insert('t_mutukamarop', $data);
    }
}
